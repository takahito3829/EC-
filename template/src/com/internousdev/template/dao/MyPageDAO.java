...
public class MyPageDAO {
	...
	String sql ="SELECT ubit.id, iit.item_name, ubit.total_price, ubit.total_count, ubit.pay, ubit.insert_date "
			         + "FROM user_buy_item_transaction ubit "//ubitはテーブルに略語で名前をつけているだけ。 ubitの前にasが隠れている
			         + "LEFT JOIN item_info_transaction iit ON ubit.item_transaction_id = iit.id "//iitも同じくテーブル名の略語で命名しているだけ。
